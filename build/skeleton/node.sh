...
update_script()
{
    ...
    local SCRIPT_URL=https://raw.githubusercontent.com/4HM3DMD/Elastos.Node/master/build/skeleton/node.sh
    local SHA_URL=https://raw.githubusercontent.com/4HM3DMD/Elastos.Node/master/build/skeleton/node.sh.sha256
